 ...
 *
 * modified for Bootstrap 3.0 support
    ...
    $.fn.bootpag = function(options){
        ...
        return this.each(function(){
            ...
            var $bootpag, lp, me = $(this),
                p = ['<ul class="bootpag '+ settings.paginationClass +'">']; // added settings.paginationClass setting to apply pagination classes for Bootstrap 3.0
            ...
            me.append(p.join('')); // addClass('pagination') removed to support bootstrap 3.0
